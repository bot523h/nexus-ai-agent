...
| 11 | Contradiction Engine | [`11-contradictions.md`](11-contradictions.md) | CLAIM A/B + SOURCE A/B + why different + verifiable + status | **14 open contradictions** (`K-01`…`K-14`) + **3 resolved** non-contradictions |
