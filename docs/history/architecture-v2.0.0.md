...
> **ARCHIVED (2026-09-21).** This is the v2.0.0 architecture page, kept for traceability.
> It describes the system as of v2.0.0 and is **not** a source of truth: several tiers it
> depicts (Dropbox/pCloud/Internxt/MEGA cloud routing, the 6-section inline menu, the
> Gemini-only AI layer) have since been replaced. The current architecture is
> [`docs/architecture.md`](../architecture.md) → [`docs/architecture/`](../architecture/).
> Nothing was deleted in the move; only this banner was added ([ADR 0001](../architecture/adr/0001-docs-as-code-layout.md)).
