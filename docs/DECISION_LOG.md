...
**Status:** Canonical historical record; revision 12 effective 2026-09-25  
**r12 scope:** release integration (session `arena/01a0d6df-nexus-ai-agent`): PR#79 (security) + PR#81 (Gate 5) merged in order onto main `52ab7e8`, D-0013..D-0016 lifecycle chain renumbered to D-0017..D-0020, board claims released.  
...
- **r12 (2026-09-25, release integration):** PR#79 merged as `fe95cf0` (security D-0015/D-0016; head `3cb54f1`, CI 8/8 runs 36097562948/36097559863; post-merge push CI 4/4 run 36098254296), then PR#81 merged as `52ab7e8` (Gate 5 fencing D-0017..D-0020 after renumber; head `cef7045`, CI 8/8 runs 36099037340/36099032935). Integration resolutions: r9/r10/r11 renumber (Gate 2 owned r9), hygiene-guard repair of the gemini re-export test (AST existence pin, no SUT change), task-179 stewardship-release. Residual OPENs: handleError double-fault stderr replay, finalize `.prev` effect pinning, decimal/hex encoded-IP committed pinning, production backup + restore (task-164, PRODUCTION UNVERIFIED).
