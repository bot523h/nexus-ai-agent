...
```mermaid
flowchart LR
    arch["tests/architecture/ (15 files)<br/>AST + JSON, no production imports<br/>structural laws"]
    unit["tests/unit/ (83 files)<br/>pure, deterministic, faked I/O"]
    integ["tests/integration/ (13 files)<br/>real queue · real saver · real SQLite/PG · real FFmpeg"]
